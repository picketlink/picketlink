...
@SuiteClasses({ DigestCredentialTestCase.class, PasswordCredentialTestCase.class, RealmManagementTestCase.class, TierManagementTestCase.class, GroupMembershipTestCase.class,
