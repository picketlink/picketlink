...
public class GroupQueryTestCase extends AbstractIdentityManagerTestCase {
    ...
    public void testFindByGroupDefinedMultiValuedAttributes() throws Exception {
        ...
        someGroup.setAttribute(new Attribute<String[]>("someAttribute", new String[] {"someAttributeValue1", "someAttributeValue2"}));
        ...
        someGroup.setAttribute(new Attribute<String[]>("someAttribute", new String[] {"someAttributeValue1", "someAttributeValueChanged"}));
        someGroup.setAttribute(new Attribute<String[]>("someAttribute2", new String[] {"someAttribute2Value1", "someAttribute2Value2"}));
