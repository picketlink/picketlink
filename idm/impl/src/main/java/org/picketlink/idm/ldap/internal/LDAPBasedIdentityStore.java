...
public class LDAPBasedIdentityStore implements IdentityStore<LDAPConfiguration> {
    ...
    public <T extends IdentityType> List<T> fetchQueryResults(IdentityQuery<T> identityQuery) {
        ...
        if (IDMUtil.isAgentType(identityQuery.getIdentityType())) {
            ...
            if (identityQuery.getParameters().containsKey(User.HAS_ROLE)) {
                String roleOfFilter = findByHasRole(identityQuery);
            ...
            if (identityQuery.getParameters().containsKey(User.MEMBER_OF)) {
                String memberOfFilter = findMemberOf(identityQuery);
            ...
            if (identityQuery.getParameters().containsKey(IdentityType.HAS_GROUP_ROLE)) {
                String hasGroupRoleFilter = findHasGroupRole(identityQuery);
            ...
            if (identityQuery.getParameters().containsKey(Role.ROLE_OF)) {
                String rolesOfFilter = findByRoleOf(identityQuery);
            ...
            if (identityQuery.getParameters().containsKey(Group.HAS_MEMBER)) {
                String hasMemberFilter = findByHasMember(identityQuery);
            ...
            if (identityQuery.getParameters().containsKey(Group.PARENT)) {
                String parentGroupFilter = findByParentGroup(identityQuery);
    ...
    private <T extends LDAPIdentityType> T lookupEntryById(Class<T> type, String id) {
    ...
    private String findByParentGroup(IdentityQuery<?> identityQuery) {
    ...
    private String findByHasMember(IdentityQuery<?> identityQuery) {
        ...
        return getEntryFilterForMembers(agents, this.configuration.getGroupDNSuffix());
    }

    private String findByRoleOf(IdentityQuery<?> identityQuery) {
        ...
        return getEntryFilterForMembers(agents, this.configuration.getRoleDNSuffix());
    }

    private String findHasGroupRole(IdentityQuery<?> identityQuery) {
    ...
    private String findMemberOf(IdentityQuery<?> identityQuery) {
        ...
        return getUsersFilterMemberOf(groups);
    }

    private String findByHasRole(IdentityQuery<?> identityQuery) {
        ...
        return getUsersFilterMemberOf(roles);
    }
