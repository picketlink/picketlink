...
import org.picketlink.idm.internal.util.properties.MethodProperty;
import org.picketlink.idm.internal.util.properties.Properties;
import org.picketlink.idm.internal.util.properties.Property;

/**
 * <p>
 * Queries a target class for properties that match certain criteria. A property may either be a private or public field,
 * declared by the target class or inherited from a superclass, or a public method declared by the target class or inherited
 * from any of its superclasses. For properties that are exposed via a method, the property must be a JavaBean style property,
 * i.e. it must provide both an accessor and mutator method according to the JavaBean specification.
 * </p>
 * <p/>
 * <p>
...
public class PropertyQuery<V> {
    ...
    /**
     * Get a single result from the query, causing the query to be run. An exception is thrown if the query does not return
     * exactly one result.
     *
