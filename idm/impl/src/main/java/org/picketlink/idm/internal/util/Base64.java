...
public class Base64 {
    ...
    public static byte[] decode(byte[] source, int off, int len) {
        ...
        for (i = off; i < off + len; i++) {
            ...
            if (sbiDecode >= WHITE_SPACE_ENC) // White space, Equals sign or better
            {
                ...
                throw new IllegalStateException("Invalid Base64 character found:" + source[i]);
            } // end else:
    ...
    public static byte[] decodeFromFile(String filename) {
        ...
        try {
            ...
            throw new IllegalStateException("Error decoding from file:" + filename, e);
        } // end catch: IOException
        finally {
            try {
                bis.close();
    ...
    public static String encodeFromFile(String filename) {
        ...
        try {
            ...
            throw new RuntimeException("Error decoding from file:" + filename, e);
        } // end catch: IOException
        finally {
            try {
                bis.close();
    ...
    public static class InputStream extends java.io.FilterInputStream {
        ...
        public int read() throws java.io.IOException {
            ...
            if (position < 0) {
                ...
                // Else decoding
                    ...
                    if (i == 4) {
                        ...
                        throw new IllegalStateException("invalidBase64Padding");
                    } // end
            ...
            // Else error
                ...
                throw new RuntimeException("errorReadingBase64Stream");
            } // end else
        } // end read
        ...
        public void write(int theByte) throws java.io.IOException {
            ...
            // Else, Decoding
                ...
                if (DECODABET[theByte & 0x7f] > WHITE_SPACE_ENC) {
                    ...
                    throw new java.io.IOException("invalidBase64Character" + ((byte) theByte));
        ...
        public void flushBase64() throws java.io.IOException {
            if (position > 0) {
                if (encode) {
                    ...
                    throw new RuntimeException("invalidBase64Padding");
                } // end else: decoding
