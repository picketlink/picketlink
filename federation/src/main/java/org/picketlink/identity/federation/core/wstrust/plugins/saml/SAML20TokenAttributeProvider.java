...
/**
 * <p>
 * An interface used by {@code SAML20TokenProvider} to retrieve an environment specific attribute that will be inserted into the
 * Assertion.
 * </p>
 *
...
public interface SAML20TokenAttributeProvider {
    ...
    /**
     * Given the security context, environment or other static or non-static criteria, returns an attribute statement to be
