...
public class RequestSecurityToken implements BaseRequestSecurityToken {
    ...
    /**
     * <p>
     * Obtains the {@code AppliesTo} value of this request. The {@code AppliesTo} object identifies the service provider (web
    ...
    /**
     * <p>
     * Sets the {@code AppliesTo} value of this request. The {@code AppliesTo} object identifies the service provider (web
     * service) that requires a token to be presented by clients. A STS uses this object to find the type of the token that is
     * accepted by the service provider so that it can issue appropriate tokens to clients.
     * </p>
     *
     ...
     * </p>
     *
     * @param allowPostDating {@code null} if the token can't have a future lifetime (e.g. a token to be used the next day); a
     *        {@code AllowPostdatingType} otherwise.
     */
     ...
     * </p>
     *
     * @return a reference to the {@code OnBehalfOfType} that represents the identity on whose behalf this request was made.
     */
    ...
    /**
     * <p>
     * Sets the {@code Encryption} section of the request. The {@code Encryption} element indicates that the requestor desires
    ...
    /**
     * <p>
     * Obtains the {@code ProofEncryption} section of the request. The {@code ProofEncryption} indicates that the requester
     * desires any returned secrets in issued security tokens to be encrypted.
     * </p>
     *
    ...
    /**
     * <p>
     * Sets the {@code ProofEncryption} section of the request. The {@code ProofEncryption} indicates that the requester desires
     * any returned secrets in issued security tokens to be encrypted.
     * </p>
     *
    ...
    /**
     * <p>
     * Indicates whether the requested token should be marked as "forwardable" or not. In general, this flag is used when a
     * token is normally bound to the requestor's machine or service. Using this flag, the returned token MAY be used from any
     * source machine so long as the key is correctly proven.
     * </p>
     *
    ...
    /**
     * <p>
     * Specifies whether the requested token should be marked as "forwardable" or not. In general, this flag is used when a
     * token is normally bound to the requestor's machine or service. Using this flag, the returned token MAY be used from any
     * source machine so long as the key is correctly proven.
     * </p>
     *
    ...
    /**
     * <p>
     * Indicates whether the requested token should be marked as "delegatable" or not. Using this flag, the returned token MAY
    ...
    /**
     * <p>
     * Specifies whether the requested token should be marked as "delegatable" or not. Using this flag, the returned token MAY
     * be delegated to another party.
     * </p>
     *
    ...
    /**
     * <p>
     * Obtains the {@code Policy} associated with the request. The policy specifies defaults that can be overridden by the
     * previous properties.
     * </p>
     *
    ...
    /**
     * <p>
     * Sets the {@code Policy} in the request. The policy specifies defaults that can be overridden by the previous properties.
     * </p>
     *
     ...
     * </p>
     *
     * @return a reference to the {@code CancelTargetType} that represents the {@code CancelTarget} section of the WS-Trust
     *         cancel request.
     */
     ...
     * </p>
     *
     * @return a reference to the {@code RenewTargetType} that represents the {@code RenewTarget} section of the WS-Trust renew
     *         request.
     */
    ...
    /**
     * <p>
     * Obtains the {@code ValidateTarget} section of the request. This element identifies the token that is to be validated.
     * </p>
     *
     * @return a reference to the {@code ValidateTargetType} that represents the {@code ValidateTarget} section of the WS-Trust
     *         validate request.
     */
     ...
     * </p>
     *
     * @return the {@code Element} that represents the renew target type, or {@code null} if no renew target is found in the
     *         document.
     */
    ...
    /**
     * <p>
     * Sets the {@code ValidateTarget} section of the request. This elements identifies the token that is to be validated.
     * </p>
     *
     * @param validateTarget a reference to the {@code ValidateTargetType} that identifies the token that must be validated.
     */
    ...
    /**
     * <p>
     * Obtains a map that contains attributes that aren't bound to any typed property on the request. This is a live reference,
    ...
    public String toString() {
        return "RequestSecurityToken [delegate=" + delegate + ", tokenType=" + tokenType + ", requestType=" + requestType
                ...
                + ", issuer=" + issuer + ", authenticationType=" + authenticationType + ", keyType=" + keyType + ", keySize="
                + keySize + ", signatureAlgorithm=" + signatureAlgorithm + ", encryption=" + encryption
                + ", encryptionAlgorithm=" + encryptionAlgorithm + ", canonicalizationAlgorithm=" + canonicalizationAlgorithm
                + ", keyWrapAlgorithm=" + keyWrapAlgorithm + ", proofEncryption=" + proofEncryption + ", useKey=" + useKey
                + ", signWith=" + signWith + ", encryptWith=" + encryptWith + ", delegateTo=" + delegateTo + ", forwardable="
                + forwardable + ", delegatable=" + delegatable + ", policy=" + policy + ", policyReference=" + policyReference
                + ", validateTarget=" + validateTarget + ", renewTarget=" + renewTarget + ", cancelTarget=" + cancelTarget
                + ", extensionElements=" + extensionElements + ", rstDocument=" + rstDocument + "]";
    }
}