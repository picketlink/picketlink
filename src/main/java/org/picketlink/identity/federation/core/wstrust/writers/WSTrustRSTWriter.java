...
public class WSTrustRSTWriter {
    ...
    /**
     * <p>
     * Creates a {@code WSTrustRSTWriter} that writes {@code RequestSecurityToken} instances to the specified {@code Result}.
     * </p>
     *
    ...
    /**
     * <p>
     * Creates a {@code WSTrustRSTWriter} that uses the specified {@code XMLStreamWriter} to write the request objects.
     * </p>
     *
    ...
    private void writeUseKeyType(UseKeyType useKeyType) throws ProcessingException {
        ...
        for (Object useKeyTypeValue : theList) {
            if (useKeyTypeValue instanceof Element) {
                ...
                throw new RuntimeException(ErrorCodes.WRITER_UNKNOWN_TYPE + "Unknown use key type:"
