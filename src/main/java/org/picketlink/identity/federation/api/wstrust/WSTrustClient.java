...
public class WSTrustClient {
    ...
    public WSTrustClient(String serviceName, String port, String[] endpointURIs, SecurityInfo secInfo) throws ParsingException {
        ...
        if (serviceName == null || port == null || endpointURIs == null || secInfo == null)
            throw logger.nullArgument("The service name, port, endpoint URIs and security info parameters cannot be null");
        if (endpointURIs.length == 0)
            throw logger.nullArgument("At least one endpoint URI must be provided");
    ...
    public Element issueToken(String tokenType) throws WSTrustException {
        if (tokenType == null)
            throw logger.nullArgument("The token type");
    ...
    public Element issueTokenForEndpoint(String endpointURI) throws WSTrustException {
        if (endpointURI == null)
            throw logger.nullArgument("The endpoint URI");
        RequestSecurityToken request = new RequestSecurityToken();
    ...
    /**
     * Issues a Security Token from the STS. This methods has the option of specifying both or one of endpointURI/tokenType but
    ...
    public Element issueToken(String endpointURI, String tokenType) throws WSTrustException {
        if (endpointURI == null && tokenType == null)
            throw logger.nullArgument("Either the token type or endpoint URI must be specified");
    ...
    public Element issueTokenOnBehalfOf(String endpointURI, String tokenType, Principal principal) throws WSTrustException {
        if (endpointURI == null && tokenType == null)
            throw logger.nullArgument("Either the token type or endpoint URI must be specified");
        if (principal == null)
            throw logger.nullArgument("The on-behalf-of principal");
    ...
    public Element issueToken(RequestSecurityToken request) throws WSTrustException {
        if (request == null)
            throw logger.nullArgument("request");
        return this.issueInternal(request, 0);
    }
    ...
    /**
     * <p>
     * This method issues a token using the specified request and has failover support when more than one endpoint URI has been
     * provided in the constructor. If a {@code ConnectException} occurs when sending the WS-Trust request to one endpoint, the
     ...
     * @param clientIndex an {@code int} that indicates which of the {@code STSClient} instances should be used to perform the
     *        request.
    ...
    /**
     * <p>
     * This method renews the specified token and has failover support when more than one endpoint URI has been provided in the
     * constructor. If a {@code ConnectException} occurs when sending the WS-Trust request to one endpoint, the code makes a new
    ...
    /**
     * <p>
     * This method validates the specified token and has failover support when more than one endpoint URI has been provided in
     * the constructor. If a {@code ConnectException} occurs when sending the WS-Trust request to one endpoint, the code makes a
    ...
    /**
     * <p>
     * This method cancels the specified token and has failover support when more than one endpoint URI has been provided in the
     * constructor. If a {@code ConnectException} occurs when sending the WS-Trust request to one endpoint, the code makes a new
     * attempt using the next URI until the request reaches an STS instance or all URIs have been tried.
     * </p>
     *
