 ...
 * @since Oct 1, 2014
 */
public class SCIMSchemaElement {
    ...
    public SCIMSchemaElement setId(String id) {
        this.id = id;
        return this;
    }
    ...
    public SCIMSchemaElement setName(String name) {
        this.name = name;
        return this;
    }
    ...
    public SCIMSchemaElement setDescription(String description) {
    ...
    public SCIMSchemaElement setAttributes(Attributes[] attributes) {
    ...
    public SCIMSchemaElement setMeta(Meta meta) {
        this.meta = meta;
        return this;
    }
