...
public class PicketLinkIDMDataProvider implements DataProvider {
    ...
    @Override
    public SCIMGroup getGroups(String id) {
        verifyIdentityManager();
    ...
    @Override
    public SCIMResourceType getResource(String id) {
        SCIMResourceType scimResource = new SCIMResourceType();
        return scimResource;
    }
    ...
    @Override
    public String createGroup(SCIMGroup group) {
        verifyIdentityManager();
