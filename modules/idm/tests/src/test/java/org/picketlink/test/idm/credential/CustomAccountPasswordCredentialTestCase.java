...
public class CustomAccountPasswordCredentialTestCase extends AbstractPasswordCredentialTestCase {

    public CustomAccountPasswordCredentialTestCase(IdentityConfigurationTester builder) {
        super(builder);
    }
