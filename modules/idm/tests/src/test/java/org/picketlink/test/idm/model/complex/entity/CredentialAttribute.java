...
public class CredentialAttribute implements Serializable {
    ...
    @OwnerReference
    @ManyToOne
    private AttributedTypeObject identity;
    ...
    @ManyToOne
    private CredentialAttribute credentialAttribute;
    ...
    public CredentialAttribute getCredentialAttribute() {
        return credentialAttribute;
    }

    public void setCredentialAttribute(CredentialAttribute credentialAttribute) {
