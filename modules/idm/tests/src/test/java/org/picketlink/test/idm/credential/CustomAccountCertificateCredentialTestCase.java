...
public class CustomAccountCertificateCredentialTestCase extends AbstractCertificateCredentialTestCase {

    public CustomAccountCertificateCredentialTestCase(IdentityConfigurationTester builder) {
        super(builder);
    }
