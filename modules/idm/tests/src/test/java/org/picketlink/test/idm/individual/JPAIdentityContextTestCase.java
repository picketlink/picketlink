...
public class JPAIdentityContextTestCase {
    ...
    private static IdentitySessionFactory createFactory() {
        ResourceLocalJpaIdentitySessionHandler handler = new ResourceLocalJpaIdentitySessionHandler("jpa-identity-store-realm-tests");
    ...
    {
        ctx = factory.createIdentitySession();
    }
