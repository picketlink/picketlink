...
public interface IDMMessages {
    ...
    @Message(id = 8, value = "Unsupported AttributedType [%s].")
    ...
    @Message(id = 10, value = "Method not implemented, yet.")
    ...
    @Message(id = 12, value = "Could not find class [%s].")
    ...
    @Message(id = 17, value = "QueryParameter [%s] is not supported for sorting.")
    IdentityManagementException notSortableQueryParameter(QueryParameter queryParam);

    @Message(id = 18, value = "Feature set has already been locked, no additional features may be added.")
    SecurityConfigurationException storeConfigLockedFeatureSet();

    @Message(id = 19, value = "The specified realm [%s] has not been configured.")
    ...
    @Message(id = 30, value = "No Group found with the given path [%s] for Partition [%s].")
    IdentityManagementException groupNotFoundWithPath(String path, Partition partition);

    @Message(id = 31, value = "No Parent Group found with the given id [%s] for Partition [%s].")
    IdentityManagementException groupParentNotFoundWithId(String id, Partition partition);

    @Message(id = 32, value = "Ambiguos relationship found [%s].")
    IdentityManagementException relationshipAmbiguosFound(Relationship relationship);

    @Message(id = 33, value = "Unsupported IdentityType. Group members are only Agent or Group instances. You provided [%s].")
    IdentityManagementException relationshipUnsupportedGroupMemberType(IdentityType identityType);

    @Message(id = 34, value = "Unsupported type for the Grant assignee. Roles are granted for Agent and Group only. You provided [%s].")
    IdentityManagementException relationshipUnsupportedGrantAssigneeType(IdentityType identityType);

    @Message (id = 35, value = "Could not add Relationship [%s].")
    ...
    @Message (id = 37, value = "Could not update Relationship [%s].")
    ...
    @Message(id = 39, value = "Partition not found with id [%s].")
    IdentityManagementException partitionNotFoundWithId(String id);

    @Message(id = 40, value = "Unsupported partition type [%s].")
    ...
    @Message(id = 43, value = "Partition [%s] could not be removed. There are IdentityTypes associated with it. Remove them first.")
    IdentityManagementException partitionCouldNotRemoveWithIdentityTypes(Partition partition);

    @Message(id = 44, value = "Partition [%s] could not be removed. There are child partitions associated with it. Remove them first.")
    ...
    @Message(id = 47, value = "Ambiguous property [%s] property in class [%s]")
    SecurityConfigurationException jpaConfigAmbiguousPropertyForClass(String name, Class<?> targetClass);

    @Message(id = 48, value = "Model property [%s] has not been configured.")
    SecurityConfigurationException jpaConfigModelPropertyNotConfigured(String name);

    @Message(id = 49, value = "Error initializing JpaIdentityStore - identityClass not set.")
    ...
    @Message(id = 51, value = "Multiple properties defined for attribute [%s] - Property: %s.%s, Property: %s.%s")
    ...
    @Message(id = 74, value = "Credentials can only be managed from a Realm. Current partition is [%s].")
    IdentityManagementException partitionInvalidTypeForCredential(Class<? extends Partition> partitionType);

    @Message(id = 75, value = "The same IdentityType [%s] was configured for different IdentityStoreConfiguration [%s, %s].")
    ...
    @Message(id = 76, value = "The same Relationship [%s] was configured for different IdentityStoreConfiguration [%s, %s].")
    ...
    @Message(id = 79, value = "Illegal Operation.")
