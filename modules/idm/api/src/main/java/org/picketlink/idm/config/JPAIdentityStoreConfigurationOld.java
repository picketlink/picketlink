 ...
 *
 */
public class JPAIdentityStoreConfigurationOld extends BaseAbstractStoreConfiguration {
    ...
    JPAIdentityStoreConfigurationOld(Class<?> identityClass, Class<?> attributeClass, Class<?> credentialClass,
    ...
    private void configureAttributes() throws SecurityConfigurationException {
        ...
        if (attributeClass != null) {
            ...
            configureModelProperty(PropertyType.ATTRIBUTE_NAME, AttributeName.class, attributeClass, null, "attributeName",
                    "name");
            configureModelProperty(PropertyType.ATTRIBUTE_CLASS, AttributeClass.class, attributeClass, null, "attributeType",
                    "type");
    ...
    private void configureCredentials() {
        if (this.credentialClass != null && this.credentialAttributeClass != null) {
            configureModelProperty(PropertyType.CREDENTIAL_CLASS, CredentialClass.class, credentialClass, null);
