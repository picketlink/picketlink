...
//
//        if (results.isEmpty()) {
//            throw MESSAGES.attributedTypeNotFoundWithId(IdentityType.class, id, context.get());
//        } else {
...
//
//        partitionIds.add(context.get().getId());
//
...
//
//        if (results.isEmpty()) {
//            throw MESSAGES.attributedTypeNotFoundWithId(Relationship.class, id, context.get());
//        } else {
//            return results.get(0);
//        }
//    }
...
//                            identityQuery.setParameter(IdentityType.PARTITION, identityType.get());
//
...
//                                if (Realm.class.isInstance(context.get()) && !context.get().equals(identityType.get())) {
//                                    if (!Tier.class.isInstance(identityType.get())) {
//                                        return result;
//                                    }
//                                }
//                            }
...
//    }
    ...
    @Override
    public JPAIdentityStoreConfiguration getConfig() {
        return null;  //TODO: Implement getConfig
    }
