...
public class FileIdentityQueryHelper {
    ...
    public boolean matchRolesOf(IdentityContext context, IdentityType identityType) {
        ...
        if (values != null) {
            ...
            List<FileRelationship> relationships = identityStore.getRelationships().get(
                    Grant.class.getName());
...
//                            context, GroupMembership.class, this.identityStore);
                    ...
                    DefaultRelationshipQuery<GroupMembership> query = null;
...
//                            GroupRole.class, identityStore);
                    ...
                    RelationshipQuery<GroupRole> query = null;
...
//                            context, GroupMembership.class, identityStore);
                    ...
                    RelationshipQuery<GroupMembership> query = null;
...
//                    RelationshipQuery<Grant> query = new DefaultRelationshipQuery<Grant>(context, Grant.class, identityStore);
                    RelationshipQuery<Grant> query = null;
