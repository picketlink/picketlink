...
public class AttributeTypeMapper extends AbstractModelMapper {
    ...
    public boolean supports(Class<?> entityType) {
        ...
        return mappedAttribute != null && isNullOrEmpty(mappedAttribute.name()) && getAnnotatedProperty(AttributeName.class, entityType) != null
    ...
    public EntityMapping doCreateMapping(Class<?> managedType, Class<?> entityType) {
        EntityMapping entityMapping = new EntityMapping(Attribute.class, true);
