 ...
 * </p>
 * <p>
 * This class also tests the use of the {@code SPRedirectSignatureFormAuthenticator.idpAddress} and the
 * {@code IDPWebBrowserSSOValve.validatingAliasToTokenIssuer} properties during the token's signature validation process.
 * </p>
 * <p>
 ...
 * <li>User's machine is different of the SP and the IDP. (testSAML2RedirectWithSifferentConsumerAndProvider) <br/>
 * 192.168.1.1 -> IDP Address (IDP_PROFILE/WEB-INF/picketlink-idfed.xml) <br/>
 * 192.168.1.2 -> SP Address (SP_PROFILE/WEB-INF/picketlink-idfed.xml) <br/>
 * 192.168.1.3 -> End User Address</li>
 * <ul>
 * </p>
 *
...
public class SAML2RedirectSignatureTomcatWorkflowUnitTestCase extends AbstractSAML2RedirectWithSignatureTestCase {
    ...
    /**
     * Tests the token's signatures validations when the requester and the SP/IDP as on the same host. The keyprovider is
     * configured with the same ValidatingAlias for all of them.
     *
     * @throws Exception
     */
    @Test
    ...
    /**
     * Tests the token's signatures validations when the requester is in a differente host than the SP and IDP. <br/>
     ...
     * <li>If you ommit the SPRedirectSignatureFormAuthenticator.idpAddress because the user's address will be used to validate
     * the token. His address is not in the keystore.</li>
     * <li>If you ommit the IDPWebBrowserSSOValve.validatingAliasToTokenIssuer because the user's address will be used to
