...
@Deployment(
    beans = {
        FormCustomAuthenticationUriTestCase.SecurityConfiguration.class, SecurityInitializer.class
    },
    excludeBeansFromPackage = "org.picketlink.http.test"
)
public class FormCustomAuthenticationUriTestCase extends AbstractSecurityFilterTestCase {
    ...
    public void testFormRedirectToError() throws Exception {
        when(this.request.getServletPath()).thenReturn("/formProtectedUri/customAuthenticationUri");
    ...
    public void testSuccessfulAuthenticationPathWithoutWildCard() throws Exception {
        ...
        when(this.request.getServletPath()).thenReturn("/pathWithoutWildCard/customAuthenticationUri");
        when(this.request.getParameter(FormAuthenticationScheme.J_USERNAME)).thenReturn("picketlink");
        when(this.request.getParameter(FormAuthenticationScheme.J_PASSWORD)).thenReturn("picketlink");
    ...
    public void testRestoreOriginalRequest() throws Exception {
        ...
        when(this.request.getServletPath())
            .thenReturn("/formProtectedUriRestoreOriginalRequest/customAuthenticationUri");
        when(this.request.getParameter(FormAuthenticationScheme.J_USERNAME)).thenReturn("picketlink");
        when(this.request.getParameter(FormAuthenticationScheme.J_PASSWORD)).thenReturn("picketlink");
            ...
            builder
                .http()
                    .forPath("/formProtectedUri/*")
                        .authenticateWith()
                            .form()
                                .authenticationUri("/customAuthenticationUri")
