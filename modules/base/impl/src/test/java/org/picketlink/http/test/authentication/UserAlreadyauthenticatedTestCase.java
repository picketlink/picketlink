...
@Deployment(
    beans = {
        UserAlreadyauthenticatedTestCase.SecurityConfiguration.class, SecurityInitializer.class
    },
    excludeBeansFromPackage = "org.picketlink.http.test"
)
public class UserAlreadyauthenticatedTestCase extends AbstractSecurityFilterTestCase {
    ...
    public void onBefore() throws Exception {
        ...
        // reset the credentials to not start authentication
