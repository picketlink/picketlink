...
public class HttpSecurityCorsConfigTestCase {
    ...
    public void testHttpCorsPathConfig() {
        ...
        Set<String> supportedMethods = corsConfiguration.getSupportedMethods();
        ...
        Set<String> supportedHeaders = corsConfiguration.getSupportedHeaders();
        ...
        assertTrue(corsConfiguration.isCredentialsSupported());
    ...
    public void testHttpPathGroupConfig() {
        ...
        assertTrue(corsConfiguration.isAnyHeaderSupported());
