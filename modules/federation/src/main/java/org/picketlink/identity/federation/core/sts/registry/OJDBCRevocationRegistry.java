...
/**
 * Implementation of
 * {@link org.picketlink.identity.federation.core.sts.registry.SecurityTokenRegistry}
 * using JDBC
 * 
 * This is a working implementation implementation based on the plink
 * JDBCRevocationRegistry which allows better jndi configuration (eg global
 ...
 * 	&lt;Property Key="RevocationRegistryJDBCNameSpace" Value="java:jboss" /&gt; &lt;!-- default value is java:jboss and can be ommited --&gt;
 * 	&lt;Property Key="RevocationRegistryJDBCDataSource" Value="jdbc/picketlink-sts" /&gt; &lt;!-- default value is jdbc/picketlink-sts and can be ommited --&gt;
 * 	...
 * &lt;/TokenProvider&gt;
 * </pre>
 * 
