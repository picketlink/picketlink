...
package org.picketlink.oauth.amber.oauth2.rs.request;
...
import org.picketlink.oauth.amber.oauth2.common.message.types.TokenType;
...
import org.picketlink.oauth.amber.oauth2.rs.BearerResourceServer;
import org.picketlink.oauth.amber.oauth2.rs.ResourceServer;
import org.picketlink.oauth.amber.oauth2.rs.extractor.TokenExtractor;
...
public class OAuthAccessResourceRequest {
    ...
    public OAuthAccessResourceRequest(HttpServletRequest request, TokenType... tokenTypes) throws OAuthSystemException,
