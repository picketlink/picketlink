...
package org.picketlink.oauth.amber.oauth2.ext.dynamicreg.server.request;

import org.picketlink.oauth.amber.oauth2.common.exception.OAuthSystemException;
import org.picketlink.oauth.amber.oauth2.common.validators.OAuthValidator;
import org.picketlink.oauth.amber.oauth2.ext.dynamicreg.common.OAuthRegistration;
import org.picketlink.oauth.amber.oauth2.as.request.OAuthRequest;
import org.picketlink.oauth.amber.oauth2.common.exception.OAuthProblemException;
import org.picketlink.oauth.amber.oauth2.ext.dynamicreg.server.validator.PushPullValidator;
...
public class OAuthServerRegistrationRequest extends OAuthRequest {
    ...
    public OAuthServerRegistrationRequest(JSONHttpServletRequestWrapper request) throws OAuthSystemException,
            OAuthProblemException {
        this(request, false);
    }

    public OAuthServerRegistrationRequest(JSONHttpServletRequestWrapper request, boolean discover) throws OAuthSystemException,
            OAuthProblemException {
        super(request);
        if (discover) {
            discover();
