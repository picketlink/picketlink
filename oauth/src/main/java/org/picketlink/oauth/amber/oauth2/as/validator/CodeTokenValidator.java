...
package org.picketlink.oauth.amber.oauth2.as.validator;
...
public class CodeTokenValidator extends AbstractValidator<HttpServletRequest> {
    ...
    public void validateMethod(HttpServletRequest request) throws OAuthProblemException {
        ...
        if (!method.equals(OAuth.HttpMethod.GET) && !method.equals(OAuth.HttpMethod.POST)) {
            throw OAuthProblemException.error(OAuthError.CodeResponse.INVALID_REQUEST).description("Method not correct.");
        }
    }
