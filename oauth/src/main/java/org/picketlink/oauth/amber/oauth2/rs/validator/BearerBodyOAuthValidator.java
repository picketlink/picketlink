...
package org.picketlink.oauth.amber.oauth2.rs.validator;
...
import org.picketlink.oauth.amber.oauth2.common.validators.AbstractValidator;
...
public class BearerBodyOAuthValidator extends AbstractValidator {
    ...
    public void validateMethod(HttpServletRequest request) throws OAuthProblemException {
        ...
        if (!(OAuth.HttpMethod.POST.equals(method) || OAuth.HttpMethod.PUT.equals(method) || OAuth.HttpMethod.DELETE
                .equals(method))) {
            throw OAuthProblemException.error(OAuthError.TokenResponse.INVALID_REQUEST).description(
                    "Incorrect method. POST, PUT, DELETE are supported.");
        }
    }
    ...
    public void validateContentType(HttpServletRequest request) throws OAuthProblemException {
        if (OAuthUtils.isMultipart(request)) {
            throw OAuthProblemException.error(OAuthError.CodeResponse.INVALID_REQUEST).description(
                    "Request is not single part.");
        }
