...
import org.picketlink.oauth.amber.oauth2.common.exception.OAuthRuntimeException;
...
public class JSONHttpServletRequestWrapper extends HttpServletRequestWrapper {
    private Logger log = Logger.getLogger(JSONHttpServletRequestWrapper.class.getName());
    ...
    public Map<String, String[]> getParameterMap() {
        try {
            ...
            log.log(Level.SEVERE, "Dynamic client registration error: ", e);
    ...
    private void readJsonBody() {
        if (!bodyRead) {
            ...
            try {
                ...
                log.log(Level.SEVERE, "Cannot decode request body as a JSON: ", e);
            } catch (Exception e) {
                log.log(Level.SEVERE, "Dynamic client registration error: ", e);
                throw new OAuthRuntimeException("OAuth server error");
            }
