...
package org.picketlink.oauth.amber.oauth2.ext.dynamicreg.server.validator;
...
public class PushPullValidator extends AbstractValidator<JSONHttpServletRequestWrapper> {
    ...
    private Logger log = Logger.getLogger(PushPullValidator.class.getName());
    ...
    private void initializeValidationParameter(JSONHttpServletRequestWrapper request) throws OAuthProblemException {
        ...
        if (log.isLoggable(Level.FINE)) {
            log.log(Level.FINE, "OAuth dynamic client registration type is: {}", new String[] { requestType });
        }
    }
}
