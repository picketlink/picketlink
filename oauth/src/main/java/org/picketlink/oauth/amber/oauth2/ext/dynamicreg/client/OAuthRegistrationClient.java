...
package org.picketlink.oauth.amber.oauth2.ext.dynamicreg.client;

import java.io.IOException;
import java.util.HashMap;
import java.util.Map;

import org.picketlink.oauth.amber.oauth2.client.HttpClient;
...
public class OAuthRegistrationClient extends OAuthClient {
    ...
    public OAuthClientRegistrationResponse clientInfo(OAuthClientRequest request) throws IOException, OAuthSystemException,
