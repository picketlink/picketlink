...
package org.picketlink.oauth.amber.oauth2.common.error;
...
public abstract class OAuthError {
    ...
    public static final class TokenResponse {
        /**
         * The request is missing a required parameter, includes an unsupported parameter value, repeats a parameter, includes
        ...
        /**
         * The provided authorization grant (e.g. authorization code, resource owner credentials, client credentials) is
